...
export const buttonVariants = clsvDefault(
  clsv(
    'inline-flex items-center justify-center rounded-md text-sm font-medium transition-[color,background-color,box-shadow] fv-effect disabled:pointer-events-none disabled:opacity-50',
    {
      variant: {
        default:
